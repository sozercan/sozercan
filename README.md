...
- [fix: autoremove without user confirmation](https://github.com/project-copacetic/copacetic/pull/934) on [project-copacetic/copacetic](https://github.com/project-copacetic/copacetic) (2 days ago)
- [chore: update golangci-lint version](https://github.com/project-copacetic/copacetic/pull/930) on [project-copacetic/copacetic](https://github.com/project-copacetic/copacetic) (3 days ago)
...
- [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) ([b4793](https://github.com/ggml-org/llama.cpp/releases/tag/b4793), 1 day ago) - LLM inference in C/C&#43;&#43;
- [sozercan/aikit](https://github.com/sozercan/aikit) ([v0.18.0](https://github.com/sozercan/aikit/releases/tag/v0.18.0), 3 days ago) - 🏗️ Fine-tune, build, and deploy open-source LLMs easily!
...
- [substratusai/kubeai](https://github.com/substratusai/kubeai) - AI Inference Operator for Kubernetes. The easiest way to serve ML models in production. Supports VLMs, LLMs, embeddings, and speech-to-text. (1 day ago)
- [vllm-project/aibrix](https://github.com/vllm-project/aibrix) - Cost-efficient and pluggable Infrastructure components for GenAI inference (2 days ago)
- [jolovicdev/shandu](https://github.com/jolovicdev/shandu) - OpenAI DeepResearch alternative, An AI-driven research system that performs comprehensive, iterative research on any topic using multiple search engines and LLMs. (3 days ago)
- [Mellanox/network-operator](https://github.com/Mellanox/network-operator) - NVIDIA Network Operator (3 days ago)
