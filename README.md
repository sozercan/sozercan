...
- [ci: bump precommit](https://github.com/sozercan/aikit/pull/421) on [sozercan/aikit](https://github.com/sozercan/aikit) (3 days ago)
- [ci: linux/amd64 and linux/arm64 multi platform image](https://github.com/kubernetes-sigs/kustomize/pull/5799) on [kubernetes-sigs/kustomize](https://github.com/kubernetes-sigs/kustomize) (4 days ago)
...
- [ggerganov/llama.cpp](https://github.com/ggerganov/llama.cpp) ([b4067](https://github.com/ggerganov/llama.cpp/releases/tag/b4067), 1 day ago) - LLM inference in C/C&#43;&#43;
- [mudler/LocalAI](https://github.com/mudler/LocalAI) ([v2.23.0](https://github.com/mudler/LocalAI/releases/tag/v2.23.0), 2 days ago) - :robot: The free, Open Source alternative to OpenAI, Claude and others. Self-hosted and local-first. Drop-in replacement for OpenAI,  running on consumer-grade hardware. No GPU required. Runs gguf, transformers, diffusers and many more models architectures. Features: Generate Text, Audio, Video, Images, Voice Cloning, Distributed, P2P inference
...
- [buildpacks-community/kpack](https://github.com/buildpacks-community/kpack) - Kubernetes Native Container Build Service (4 days ago)
- [tariq1890/gpu-burn](https://github.com/tariq1890/gpu-burn) -  (4 days ago)
- [seatedro/asciigen](https://github.com/seatedro/asciigen) - convert images, video to ascii! (6 days ago)
- [google/kube-startup-cpu-boost](https://github.com/google/kube-startup-cpu-boost) - Kube Startup CPU Boost is a controller that increases CPU resource requests and limits during Kubernetes workload startup time (6 days ago)
