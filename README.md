...
- [sozercan/k8s-distributed-inference](https://github.com/sozercan/k8s-distributed-inference) - 🦄 Distributed Inference on Kubernetes with DRA and MIG (6 days ago)
...
- [feat: auto load into memory on startup](https://github.com/mudler/LocalAI/pull/3627) on [mudler/LocalAI](https://github.com/mudler/LocalAI) (4 days ago)
...
- [ggerganov/llama.cpp](https://github.com/ggerganov/llama.cpp) ([b3825](https://github.com/ggerganov/llama.cpp/releases/tag/b3825), 1 day ago) - LLM inference in C/C&#43;&#43;
- [mudler/LocalAI](https://github.com/mudler/LocalAI) ([v2.21.1](https://github.com/mudler/LocalAI/releases/tag/v2.21.1), 1 day ago) - :robot: The free, Open Source alternative to OpenAI, Claude and others. Self-hosted and local-first. Drop-in replacement for OpenAI,  running on consumer-grade hardware. No GPU required. Runs gguf, transformers, diffusers and many more models architectures. Features: Generate Text, Audio, Video, Images, Voice Cloning, Distributed inference
