...
- [feat: diffusers backend](https://github.com/sozercan/aikit/pull/373) on [sozercan/aikit](https://github.com/sozercan/aikit) (3 days ago)
- [using gha cache with docker-container](https://github.com/docker/docs/pull/20748) on [docker/docs](https://github.com/docker/docs) (6 days ago)
...
- [ggerganov/llama.cpp](https://github.com/ggerganov/llama.cpp) ([b3668](https://github.com/ggerganov/llama.cpp/releases/tag/b3668), today) - LLM inference in C/C&#43;&#43;
...
- [open-policy-agent/cert-controller](https://github.com/open-policy-agent/cert-controller) ([v0.11.0](https://github.com/open-policy-agent/cert-controller/releases/tag/v0.11.0), 4 weeks ago)

#### ⭐ Recent Stars

- [manifest-cyber/aibom](https://github.com/manifest-cyber/aibom) - A community wiki for all things AI/ML bill of materials (MLBOM, AIBOM) and transparency into AI/ML models.  (2 days ago)
...
- [zackelia/bclm](https://github.com/zackelia/bclm) - macOS command-line utility to limit max battery charge (6 days ago)
- [XuehaiPan/nvitop](https://github.com/XuehaiPan/nvitop) - An interactive NVIDIA-GPU process viewer and beyond, the one-stop solution for GPU process management. (6 days ago)
- [chainguard-dev/chaingpt](https://github.com/chainguard-dev/chaingpt) -  (6 days ago)
