...
- [feat: add llama 3.1 8b and 70b](https://github.com/sozercan/aikit/pull/344) on [sozercan/aikit](https://github.com/sozercan/aikit) (today)
- [ci: create semantic commit config](https://github.com/project-copacetic/copa-extension/pull/30) on [project-copacetic/copa-extension](https://github.com/project-copacetic/copa-extension) (2 days ago)
- [docs: update readme order](https://github.com/project-copacetic/copa-extension/pull/29) on [project-copacetic/copa-extension](https://github.com/project-copacetic/copa-extension) (2 days ago)
- [chore: bump localai v2.19.2](https://github.com/sozercan/aikit/pull/343) on [sozercan/aikit](https://github.com/sozercan/aikit) (2 days ago)
- [feat: update vulnerabilities text](https://github.com/project-copacetic/copa-extension/pull/27) on [project-copacetic/copa-extension](https://github.com/project-copacetic/copa-extension) (2 days ago)

#### 🚀 Latest releases I've contributed to

- [ggerganov/llama.cpp](https://github.com/ggerganov/llama.cpp) ([b3482](https://github.com/ggerganov/llama.cpp/releases/tag/b3482), today) - LLM inference in C/C&#43;&#43;
- [mudler/LocalAI](https://github.com/mudler/LocalAI) ([v2.19.2](https://github.com/mudler/LocalAI/releases/tag/v2.19.2), 4 days ago) - :robot: The free, Open Source alternative to OpenAI, Claude and others. Self-hosted and local-first. Drop-in replacement for OpenAI,  running on consumer-grade hardware. No GPU required. Runs gguf, transformers, diffusers and many more models architectures. It allows to generate Text, Audio, Video, Images. Also with voice cloning capabilities
...
- [aquasecurity/vexhub](https://github.com/aquasecurity/vexhub) -  (6 days ago)
- [aquasecurity/vex-repo-spec](https://github.com/aquasecurity/vex-repo-spec) - VEX Repository Specification (6 days ago)
- [aquasecurity/vexhub-crawler](https://github.com/aquasecurity/vexhub-crawler) - Collect VEX documents and update VEX Hub (6 days ago)
