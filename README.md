...
- [ci: auto merge dependabot prs](https://github.com/sozercan/aikit/pull/477) on [sozercan/aikit](https://github.com/sozercan/aikit) (1 day ago)
- [chore: update localai to v2.25.0](https://github.com/sozercan/aikit/pull/473) on [sozercan/aikit](https://github.com/sozercan/aikit) (4 days ago)
...
- [ggerganov/llama.cpp](https://github.com/ggerganov/llama.cpp) ([b4589](https://github.com/ggerganov/llama.cpp/releases/tag/b4589), 1 day ago) - LLM inference in C/C&#43;&#43;
- [podman-desktop/podman-desktop](https://github.com/podman-desktop/podman-desktop) ([v1.16.0](https://github.com/podman-desktop/podman-desktop/releases/tag/v1.16.0), 6 days ago) - Podman Desktop is the best free and open source tool to work with Containers and Kubernetes for developers. Get an intuitive and user-friendly interface to effortlessly build, manage, and deploy containers and Kubernetes — all from your desktop.
- [open-policy-agent/gatekeeper](https://github.com/open-policy-agent/gatekeeper) ([v3.17.2](https://github.com/open-policy-agent/gatekeeper/releases/tag/v3.17.2), 6 days ago) - 🐊 Gatekeeper - Policy Controller for Kubernetes
...
- [volcengine/verl](https://github.com/volcengine/verl) - veRL: Volcano Engine Reinforcement Learning for LLM (today)
- [Jiayi-Pan/TinyZero](https://github.com/Jiayi-Pan/TinyZero) - Clean, accessible reproduction of DeepSeek R1-Zero (1 day ago)
...
- [AkihiroSuda/gomodjail](https://github.com/AkihiroSuda/gomodjail) - [Experimental] jail for Go modules (3 days ago)
