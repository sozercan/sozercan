...
- [sozercan/orka-demo-inventory](https://github.com/sozercan/orka-demo-inventory) - Small Go inventory service used as the target repository for Orka demos
...
- [uncoolburrito/meld](https://github.com/uncoolburrito/meld) - One Mac app for both YouTube Music and Spotify, with proper artwork and synced lyrics for both. (2 weeks ago)
...
- [sozercan/gozillo](https://github.com/sozercan/gozillo) - 🏠 Standalone agent-friendly CLI for Zillow (2 weeks ago)

#### 🔨 My recent Pull Requests

- [docs: list Qwen3-TTS in model catalogs](https://github.com/kaito-project/aikit/pull/879) on [kaito-project/aikit](https://github.com/kaito-project/aikit) (1 day ago)
- [fix: clarify Orka harness v2 terminology](https://github.com/orka-agents/orka/pull/694) on [orka-agents/orka](https://github.com/orka-agents/orka) (1 day ago)
- [feat(website): link landing page to embedded demos](https://github.com/orka-agents/orka/pull/693) on [orka-agents/orka](https://github.com/orka-agents/orka) (1 day ago)
- [docs: add feature-based video demos](https://github.com/orka-agents/orka/pull/692) on [orka-agents/orka](https://github.com/orka-agents/orka) (1 day ago)
- [fix(security): Unauthenticated OS command injection via /create markdown image URL](https://github.com/sozercan/nodejs-goof/pull/38) on [sozercan/nodejs-goof](https://github.com/sozercan/nodejs-goof) (1 day ago)
- [fix(release): keep XCTest suites running in the release job](https://github.com/sozercan/kaset/pull/505) on [sozercan/kaset](https://github.com/sozercan/kaset) (1 day ago)
- [fix(release): add missing ja string and serialize release tests](https://github.com/sozercan/kaset/pull/504) on [sozercan/kaset](https://github.com/sozercan/kaset) (1 day ago)
- [feat: allow tasks to name pull requests](https://github.com/orka-agents/orka/pull/682) on [orka-agents/orka](https://github.com/orka-agents/orka) (1 day ago)
- [fix(menubar): reload providers config on start](https://github.com/sozercan/vekil/pull/393) on [sozercan/vekil](https://github.com/sozercan/vekil) (1 day ago)
- [feat(release): publish downloadable CLI binaries](https://github.com/orka-agents/orka/pull/681) on [orka-agents/orka](https://github.com/orka-agents/orka) (1 day ago)

#### 🚀 Latest releases I've contributed to

- [sozercan/kaset](https://github.com/sozercan/kaset) ([v0.14.1](https://github.com/sozercan/kaset/releases/tag/v0.14.1), 1 day ago) - 📼 The missing YouTube and YouTube Music macOS app
- [sozercan/vekil](https://github.com/sozercan/vekil) ([v0.14.8](https://github.com/sozercan/vekil/releases/tag/v0.14.8), 1 day ago) - 🧑‍💼 AI gateway exposing Anthropic, Gemini, and OpenAI-compatible APIs, backed by GitHub Copilot, OpenAI Codex, Microsoft Foundry, and compatible model servers
- [orka-agents/orka](https://github.com/orka-agents/orka) ([v0.2.0](https://github.com/orka-agents/orka/releases/tag/v0.2.0), 4 days ago) - 🐋 Cloud and AI-native multi-agent orchestration platform for Kubernetes
...
- [open-policy-agent/gatekeeper](https://github.com/open-policy-agent/gatekeeper) ([v3.23.1](https://github.com/open-policy-agent/gatekeeper/releases/tag/v3.23.1), 4 weeks ago) - 🐊 Policy Controller for Kubernetes
...
- [sozercan/copacetic](https://github.com/sozercan/copacetic) ([v0.3.0](https://github.com/sozercan/copacetic/releases/tag/v0.3.0), 3 years ago) - CLI tool for directly patching container images using reports from vulnerability scanners

#### ⭐ Recent Stars

- [eat-pray-ai/yutu](https://github.com/eat-pray-ai/yutu) - The AI-powered toolkit that grows your YouTube channel on autopilot. (1 day ago)
- [kaimahi-agents/kaimahi](https://github.com/kaimahi-agents/kaimahi) - Agent Builder CLI for Kubernetes. (3 days ago)
- [zai-org/ZCode](https://github.com/zai-org/ZCode) - Z.ai's coding agent harness. Powerful, intelligent, extensible. (4 days ago)
...
- [openclaw/clickclack](https://github.com/openclaw/clickclack) - ClickClackClaw - The chat app with claws. (5 days ago)
...
- [trycua/cua](https://github.com/trycua/cua) - Scale computer-use 2.0 with open-source drivers, cross-OS fleets, and benchmarks for training, evaluation, and data generation. (6 days ago)
- [githubnext/localjev](https://github.com/githubnext/localjev) (6 days ago)
