...
- [sozercan/k8s-distributed-inference](https://github.com/sozercan/k8s-distributed-inference) - 🦄 Distributed Inference on Kubernetes with DRA and MIG (1 day ago)
...
- [enable mig](https://github.com/sozercan/k8s-distributed-inference/pull/7) on [sozercan/k8s-distributed-inference](https://github.com/sozercan/k8s-distributed-inference) (1 day ago)
- [docs: add search](https://github.com/sozercan/aikit/pull/386) on [sozercan/aikit](https://github.com/sozercan/aikit) (5 days ago)
...
- [ggerganov/llama.cpp](https://github.com/ggerganov/llama.cpp) ([b3779](https://github.com/ggerganov/llama.cpp/releases/tag/b3779), 1 day ago) - LLM inference in C/C&#43;&#43;
- [open-policy-agent/gatekeeper](https://github.com/open-policy-agent/gatekeeper) ([v3.17.1](https://github.com/open-policy-agent/gatekeeper/releases/tag/v3.17.1), 6 days ago) - 🐊 Gatekeeper - Policy Controller for Kubernetes
...
- [ToTheBeginning/PuLID](https://github.com/ToTheBeginning/PuLID) - Official code for PuLID: Pure and Lightning ID Customization via Contrastive Alignment (4 days ago)
