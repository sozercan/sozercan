...
- [feat: diffusers backend](https://github.com/sozercan/aikit/pull/373) on [sozercan/aikit](https://github.com/sozercan/aikit) (2 days ago)
- [using gha cache with docker-container](https://github.com/docker/docs/pull/20748) on [docker/docs](https://github.com/docker/docs) (5 days ago)
- [chore: update localai to v2.20.1](https://github.com/sozercan/aikit/pull/369) on [sozercan/aikit](https://github.com/sozercan/aikit) (6 days ago)
...
- [ggerganov/llama.cpp](https://github.com/ggerganov/llama.cpp) ([b3661](https://github.com/ggerganov/llama.cpp/releases/tag/b3661), 1 day ago) - LLM inference in C/C&#43;&#43;
...
- [manifest-cyber/aibom](https://github.com/manifest-cyber/aibom) - A community wiki for all things AI/ML bill of materials (MLBOM, AIBOM) and transparency into AI/ML models.  (1 day ago)
...
- [zackelia/bclm](https://github.com/zackelia/bclm) - macOS command-line utility to limit max battery charge (5 days ago)
...
- [chainguard-dev/chaingpt](https://github.com/chainguard-dev/chaingpt) -  (5 days ago)
