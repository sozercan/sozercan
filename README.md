...
- [orka-agents/.github](https://github.com/orka-agents/.github) (1 day ago)
...
- [orka-agents/orka-gateway-telegram](https://github.com/orka-agents/orka-gateway-telegram) - Out-of-tree Telegram adapter for the Orka generic gateway protocol (2 days ago)
...
- [chore: test Microsoft CLA policy processing](https://github.com/orka-agents/.github/pull/6) on [orka-agents/.github](https://github.com/orka-agents/.github) (1 day ago)
- [feat(runtime): support skills and governed tool workflows](https://github.com/sozercan/agentkit/pull/25) on [sozercan/agentkit](https://github.com/sozercan/agentkit) (1 day ago)
- [feat(broker): support AgentKit tool continuations](https://github.com/orka-agents/agent-runtime-foundry/pull/3) on [orka-agents/agent-runtime-foundry](https://github.com/orka-agents/agent-runtime-foundry) (1 day ago)
- [test(orka): add harness v2 E2E coverage for AgentKit runtimes](https://github.com/sozercan/agentkit/pull/24) on [sozercan/agentkit](https://github.com/sozercan/agentkit) (1 day ago)
- [refactor(runtime): remove harness v1 and coexistence support](https://github.com/orka-agents/orka/pull/574) on [orka-agents/orka](https://github.com/orka-agents/orka) (1 day ago)
- [chore(substrate): pin upstream v0.1.0](https://github.com/orka-agents/orka/pull/573) on [orka-agents/orka](https://github.com/orka-agents/orka) (1 day ago)
- [refactor(store): simplify SQLite setup](https://github.com/orka-agents/orka/pull/571) on [orka-agents/orka](https://github.com/orka-agents/orka) (1 day ago)
- [chore(deps): upgrade agentgateway to v1.5.0](https://github.com/orka-agents/orka-integration-agentgateway/pull/2) on [orka-agents/orka-integration-agentgateway](https://github.com/orka-agents/orka-integration-agentgateway) (1 day ago)
- [refactor: organize runtime code into internal packages](https://github.com/orka-agents/agent-runtime-foundry/pull/2) on [orka-agents/agent-runtime-foundry](https://github.com/orka-agents/agent-runtime-foundry) (1 day ago)
- [fix: make agentgateway integration compatible with Orka main](https://github.com/orka-agents/orka-integration-agentgateway/pull/1) on [orka-agents/orka-integration-agentgateway](https://github.com/orka-agents/orka-integration-agentgateway) (1 day ago)

#### 🚀 Latest releases I've contributed to

- [sozercan/vekil](https://github.com/sozercan/vekil) ([v0.14.3](https://github.com/sozercan/vekil/releases/tag/v0.14.3), 1 day ago) - 🧑‍💼 AI gateway exposing Anthropic, Gemini, and OpenAI-compatible APIs, backed by GitHub Copilot, OpenAI Codex, Microsoft Foundry, and compatible model servers
- [kubernetes-sigs/agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox) ([v1.0.2](https://github.com/kubernetes-sigs/agent-sandbox/releases/tag/v1.0.2), 1 day ago) - agent-sandbox enables easy management of isolated, stateful, singleton workloads, ideal for use cases like AI agent runtimes and reinforcement learning (RL).
...
- [orka-agents/orka-gateway-teams](https://github.com/orka-agents/orka-gateway-teams) - Out-of-tree Microsoft Teams adapter for the Orka generic gateway protocol (1 day ago)
- [Sudharsanselvaraj/Token-Print](https://github.com/Sudharsanselvaraj/Token-Print) - Interactive 3D visualization platform for exploring transformer architectures, tensors, and real-time LLM inference. (1 day ago)
- [tokenetes/tokenetes](https://github.com/tokenetes/tokenetes) - Transaction Tokens Service (1 day ago)
...
- [langchain-ai/deepagents](https://github.com/langchain-ai/deepagents) - The batteries-included agent harness. (4 days ago)
- [NVIDIA/Personal-AI-Router](https://github.com/NVIDIA/Personal-AI-Router) - Router that virtually distributes inference across connected devices in the home. (4 days ago)
...
- [backbay-labs/clawdstrike](https://github.com/backbay-labs/clawdstrike) - Agentic AI EDR for developer workstations and autonomous agent swarms. Build Swarm Detection & Response platforms with Clawdstrike. (1 week ago)
