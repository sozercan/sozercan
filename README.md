...
- [sozercan/dalec-homebrew](https://github.com/sozercan/dalec-homebrew) - 🍺 Dalec BuildKit frontend that turns verified Homebrew bottles into minimal, non-root Linux images (today)
...
- [orka-agents/agent-runtime-foundry](https://github.com/orka-agents/agent-runtime-foundry) - Microsoft Foundry Hosted Agents Responses adapter for Orka (3 weeks ago)
- [sozercan/homebrew-repo](https://github.com/sozercan/homebrew-repo) - 🍺 Homebrew tap for my projects (3 weeks ago)
- [sozercan/OpenInCode](https://github.com/sozercan/OpenInCode) - 📂 macOS Finder toolbar app to open current folder in Visual Studio Code (3 weeks ago)

#### 🔨 My recent Pull Requests

- [fix(release): validate versioned materialization evidence](https://github.com/sozercan/dalec-homebrew/pull/20) on [sozercan/dalec-homebrew](https://github.com/sozercan/dalec-homebrew) (today)
- [fix(release): assert V2 runtime evidence schemas](https://github.com/sozercan/dalec-homebrew/pull/19) on [sozercan/dalec-homebrew](https://github.com/sozercan/dalec-homebrew) (1 day ago)
- [fix(release): make metadata evidence reconciliation deterministic](https://github.com/sozercan/dalec-homebrew/pull/17) on [sozercan/dalec-homebrew](https://github.com/sozercan/dalec-homebrew) (1 day ago)
- [fix: guard release tag creation](https://github.com/kaito-project/aikit/pull/843) on [kaito-project/aikit](https://github.com/kaito-project/aikit) (1 day ago)
- [feat(inference): add vllm.cpp CPU and CUDA backends](https://github.com/kaito-project/aikit/pull/841) on [kaito-project/aikit](https://github.com/kaito-project/aikit) (1 day ago)
- [feat(finetune): add adapter-only output](https://github.com/kaito-project/aikit/pull/838) on [kaito-project/aikit](https://github.com/kaito-project/aikit) (1 day ago)
- [fix(finetune): harden dataset input handling](https://github.com/kaito-project/aikit/pull/837) on [kaito-project/aikit](https://github.com/kaito-project/aikit) (2 days ago)
- [fix(ci): restore runtime and vulnerability checks](https://github.com/project-copacetic/copacetic/pull/1670) on [project-copacetic/copacetic](https://github.com/project-copacetic/copacetic) (2 days ago)
- [fix(release): backport fixes for v1.4.2](https://github.com/eraser-dev/eraser/pull/1225) on [eraser-dev/eraser](https://github.com/eraser-dev/eraser) (2 days ago)
- [feat(inference): load configured models at startup](https://github.com/kaito-project/aikit/pull/836) on [kaito-project/aikit](https://github.com/kaito-project/aikit) (2 days ago)

#### 🚀 Latest releases I've contributed to

- [kaito-project/aikit](https://github.com/kaito-project/aikit) ([v0.22.1](https://github.com/kaito-project/aikit/releases/tag/v0.22.1), 1 day ago) - 🏗️ Fine-tune, build, and deploy open-source LLMs easily!
- [eraser-dev/eraser](https://github.com/eraser-dev/eraser) ([v1.4.2](https://github.com/eraser-dev/eraser/releases/tag/v1.4.2), 2 days ago) - 🧹 Cleaning up images from Kubernetes nodes
- [sozercan/a365cli](https://github.com/sozercan/a365cli) ([v0.3.3](https://github.com/sozercan/a365cli/releases/tag/v0.3.3), 6 days ago) - 🕵 Standalone CLI for Microsoft 365 services via Agent 365
- [sozercan/dalec-homebrew](https://github.com/sozercan/dalec-homebrew) ([v0.1.0](https://github.com/sozercan/dalec-homebrew/releases/tag/v0.1.0), 6 days ago) - 🍺 Dalec BuildKit frontend that turns verified Homebrew bottles into minimal, non-root Linux images
...
- [sozercan/OpenInCode](https://github.com/sozercan/OpenInCode) ([v2.0.0](https://github.com/sozercan/OpenInCode/releases/tag/v2.0.0), 3 weeks ago) - 📂 macOS Finder toolbar app to open current folder in Visual Studio Code
...
- [mudler/vllm.cpp](https://github.com/mudler/vllm.cpp) - a community oriented 1:1, vLLM-alike (Continuous batching, paged KV) engine in C++ with additional features (1 day ago)
- [PrimeIntellect-ai/prime-rl](https://github.com/PrimeIntellect-ai/prime-rl) - Agentic RL Training at Scale (2 days ago)
...
- [context-labs/i-need-h200s](https://github.com/context-labs/i-need-h200s) - i took one of our h200 nodes, star this repo and its yours 😉 (3 days ago)
- [ai-dynamo/snapshot](https://github.com/ai-dynamo/snapshot) (3 days ago)
- [kubernetes-sigs/cluster-autoscaler](https://github.com/kubernetes-sigs/cluster-autoscaler) - Provider-agnostic core logic for Kubernetes Cluster Autoscaler, including the cluster snapshot, scale-up/down decision logic, and external/test provider interfaces. (3 days ago)
...
- [PrimeIntellect-ai/prime-agent](https://github.com/PrimeIntellect-ai/prime-agent) - A self-improving RLM agent for coding workflows and long-running autonomous tasks. (4 days ago)
- [alpha-omega-security/threat-model](https://github.com/alpha-omega-security/threat-model) - Agent skill for producing threat models for open-source projects (5 days ago)
