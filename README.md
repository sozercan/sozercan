...
- [feat: use kompute backend for apple silicon](https://github.com/sozercan/aikit/pull/444) on [sozercan/aikit](https://github.com/sozercan/aikit) (2 days ago)
- [feat: add qwq 32b preview](https://github.com/sozercan/aikit/pull/443) on [sozercan/aikit](https://github.com/sozercan/aikit) (3 days ago)
...
- [ggerganov/llama.cpp](https://github.com/ggerganov/llama.cpp) ([b4267](https://github.com/ggerganov/llama.cpp/releases/tag/b4267), 1 day ago) - LLM inference in C/C&#43;&#43;
- [mudler/LocalAI](https://github.com/mudler/LocalAI) ([v2.24.0](https://github.com/mudler/LocalAI/releases/tag/v2.24.0), 1 day ago) - :robot: The free, Open Source alternative to OpenAI, Claude and others. Self-hosted and local-first. Drop-in replacement for OpenAI,  running on consumer-grade hardware. No GPU required. Runs gguf, transformers, diffusers and many more models architectures. Features: Generate Text, Audio, Video, Images, Voice Cloning, Distributed, P2P inference
- [podman-desktop/podman-desktop](https://github.com/podman-desktop/podman-desktop) ([v1.14.2](https://github.com/podman-desktop/podman-desktop/releases/tag/v1.14.2), 1 day ago) - Podman Desktop is the best free and open source tool to work with Containers and Kubernetes for developers. Get an intuitive and user-friendly interface to effortlessly build, manage, and deploy containers and Kubernetes — all from your desktop.
...
- [JoelSpeed/kal](https://github.com/JoelSpeed/kal) - KAL - The Kube API Linter (1 day ago)
- [huggingface/nanotron](https://github.com/huggingface/nanotron) - Minimalistic large language model 3D-parallelism training (1 day ago)
- [NVlabs/Sana](https://github.com/NVlabs/Sana) - SANA: Efficient High-Resolution Image Synthesis with Linear Diffusion Transformer (1 day ago)
- [google/capslock](https://github.com/google/capslock) -  (2 days ago)
- [Tencent/HunyuanVideo](https://github.com/Tencent/HunyuanVideo) - HunyuanVideo: A Systematic Framework For Large Video Generation Model Training (2 days ago)
