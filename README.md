...
- [ci: bump golang 1.24](https://github.com/sozercan/aikit/pull/489) on [sozercan/aikit](https://github.com/sozercan/aikit) (4 days ago)
- [chore: bump localai v2.26.0](https://github.com/sozercan/aikit/pull/487) on [sozercan/aikit](https://github.com/sozercan/aikit) (4 days ago)
- [Update bases doc for windows](https://github.com/Azure/dalec/pull/539) on [Azure/dalec](https://github.com/Azure/dalec) (5 days ago)
...
- [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) ([b4778](https://github.com/ggml-org/llama.cpp/releases/tag/b4778), 1 day ago) - LLM inference in C/C&#43;&#43;
- [sozercan/aikit](https://github.com/sozercan/aikit) ([v0.17.0](https://github.com/sozercan/aikit/releases/tag/v0.17.0), 4 days ago) - 🏗️ Fine-tune, build, and deploy open-source LLMs easily!
...
- [Mellanox/network-operator](https://github.com/Mellanox/network-operator) - NVIDIA Network Operator (today)
...
- [kubernetes-sigs/lws](https://github.com/kubernetes-sigs/lws) - LeaderWorkerSet: An API for deploying a group of pods as a unit of replication (1 week ago)
- [hoyle1974/khronoscope](https://github.com/hoyle1974/khronoscope) - Imagine a tool like k9s that also lets you rewind in time to see the status of your cluster through time. (1 week ago)
