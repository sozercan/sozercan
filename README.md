...
- [sozercan/copa-test](https://github.com/sozercan/copa-test) - 🎬 Examples of Copa usage with GitHub Actions (3 days ago)
...
- [contaienrd local move](https://github.com/sozercan/copa-test/pull/2) on [sozercan/copa-test](https://github.com/sozercan/copa-test) (3 days ago)
- [add containerd local test](https://github.com/sozercan/copa-test/pull/1) on [sozercan/copa-test](https://github.com/sozercan/copa-test) (3 days ago)
...
- [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) ([b4747](https://github.com/ggml-org/llama.cpp/releases/tag/b4747), 1 day ago) - LLM inference in C/C&#43;&#43;
- [mudler/LocalAI](https://github.com/mudler/LocalAI) ([v2.26.0](https://github.com/mudler/LocalAI/releases/tag/v2.26.0), 6 days ago) - :robot: The free, Open Source alternative to OpenAI, Claude and others. Self-hosted and local-first. Drop-in replacement for OpenAI,  running on consumer-grade hardware. No GPU required. Runs gguf, transformers, diffusers and many more models architectures. Features: Generate Text, Audio, Video, Images, Voice Cloning, Distributed, P2P inference
...
- [kubernetes-sigs/lws](https://github.com/kubernetes-sigs/lws) - LeaderWorkerSet: An API for deploying a group of pods as a unit of replication (2 days ago)
- [hoyle1974/khronoscope](https://github.com/hoyle1974/khronoscope) - Imagine a tool like k9s that also lets you rewind in time to see the status of your cluster through time. (2 days ago)
- [richinsley/jumpboot](https://github.com/richinsley/jumpboot) - Seamlessly integrate Python environments and scripts into your Go projects. (3 days ago)
- [Anemll/Anemll](https://github.com/Anemll/Anemll) - Artificial Neural Engine Machine Learning Library (6 days ago)
