...
- [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) ([b5126](https://github.com/ggml-org/llama.cpp/releases/tag/b5126), 1 day ago) - LLM inference in C/C&#43;&#43;
- [open-policy-agent/gatekeeper](https://github.com/open-policy-agent/gatekeeper) ([v3.19.0](https://github.com/open-policy-agent/gatekeeper/releases/tag/v3.19.0), 5 days ago) - 🐊 Gatekeeper - Policy Controller for Kubernetes
- [mudler/LocalAI](https://github.com/mudler/LocalAI) ([v2.27.0](https://github.com/mudler/LocalAI/releases/tag/v2.27.0), 2 weeks ago) - :robot: The free, Open Source alternative to OpenAI, Claude and others. Self-hosted and local-first. Drop-in replacement for OpenAI,  running on consumer-grade hardware. No GPU required. Runs gguf, transformers, diffusers and many more models architectures. Features: Generate Text, Audio, Video, Images, Voice Cloning, Distributed, P2P inference
- [podman-desktop/podman-desktop](https://github.com/podman-desktop/podman-desktop) ([v1.17.2](https://github.com/podman-desktop/podman-desktop/releases/tag/v1.17.2), 3 weeks ago) - Podman Desktop is the best free and open source tool to work with Containers and Kubernetes for developers. Get an intuitive and user-friendly interface to effortlessly build, manage, and deploy containers and Kubernetes — all from your desktop.
...
- [NVIDIA/KAI-Scheduler](https://github.com/NVIDIA/KAI-Scheduler) - KAI Scheduler is an open source Kubernetes Native scheduler for AI workloads at large scale (1 week ago)
