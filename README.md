...
- [headlamp-k8s/plugins](https://github.com/headlamp-k8s/plugins) - Official plugins of the Headlamp project (1 week ago)
...
- [docs: add website and move docs](https://github.com/kaito-project/kaito/pull/1183) on [kaito-project/kaito](https://github.com/kaito-project/kaito) (4 days ago)
- [fix: trivy binary check fallback](https://github.com/eraser-dev/eraser/pull/1154) on [eraser-dev/eraser](https://github.com/eraser-dev/eraser) (5 days ago)
...
- [podman-desktop/podman-desktop](https://github.com/podman-desktop/podman-desktop) ([v1.19.2](https://github.com/podman-desktop/podman-desktop/releases/tag/v1.19.2), 6 days ago) - Podman Desktop is the best free and open source tool to work with Containers and Kubernetes for developers. Get an intuitive and user-friendly interface to effortlessly build, manage, and deploy containers and Kubernetes — all from your desktop.
...
- [headlamp-k8s/plugins](https://github.com/headlamp-k8s/plugins) ([prometheus-0.6.0](https://github.com/headlamp-k8s/plugins/releases/tag/prometheus-0.6.0), 3 weeks ago) - Official plugins of the Headlamp project
...
- [gety-ai/apple-on-device-openai](https://github.com/gety-ai/apple-on-device-openai) - OpenAI-compatible API server for Apple on-device models (2 days ago)
- [Project-HAMi/HAMi](https://github.com/Project-HAMi/HAMi) - Heterogeneous AI Computing Virtualization Middleware(Project under CNCF) (4 days ago)
- [sigstore/model-transparency](https://github.com/sigstore/model-transparency) - Supply chain security for ML (6 days ago)
- [stacklok/toolhive](https://github.com/stacklok/toolhive) - ToolHive makes deploying MCP servers easy, secure and fun (6 days ago)
