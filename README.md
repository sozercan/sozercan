...
- [ci: gha to check for typos in docs](https://github.com/open-policy-agent/gatekeeper/pull/3703) on [open-policy-agent/gatekeeper](https://github.com/open-policy-agent/gatekeeper) (4 days ago)
- [chore: add typos pre commit hook](https://github.com/Azure/dalec/pull/435) on [Azure/dalec](https://github.com/Azure/dalec) (5 days ago)
- [ci: fix gator image for ghcr](https://github.com/open-policy-agent/gatekeeper/pull/3700) on [open-policy-agent/gatekeeper](https://github.com/open-policy-agent/gatekeeper) (5 days ago)
- [ci: bump to go 1.23 in gha](https://github.com/open-policy-agent/gatekeeper/pull/3699) on [open-policy-agent/gatekeeper](https://github.com/open-policy-agent/gatekeeper) (5 days ago)
- [ci: fix ghcr push](https://github.com/open-policy-agent/gatekeeper/pull/3698) on [open-policy-agent/gatekeeper](https://github.com/open-policy-agent/gatekeeper) (5 days ago)

#### 🚀 Latest releases I've contributed to

- [ggerganov/llama.cpp](https://github.com/ggerganov/llama.cpp) ([b4127](https://github.com/ggerganov/llama.cpp/releases/tag/b4127), today) - LLM inference in C/C&#43;&#43;
...
- [containers/krunkit](https://github.com/containers/krunkit) - Launch configurable virtual machines with libkrun (1 day ago)
- [crc-org/vfkit](https://github.com/crc-org/vfkit) -  (1 day ago)
- [containers/krunvm](https://github.com/containers/krunvm) - Create microVMs from OCI images (1 day ago)
- [containers/podman-desktop-extension-ai-lab-playground-images](https://github.com/containers/podman-desktop-extension-ai-lab-playground-images) -  (1 day ago)
